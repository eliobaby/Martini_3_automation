...
def main():
    ...
    tpcn_dir         = os.path.join(base_dir, "TPCN")
    csv_path         = os.path.join(tpcn_dir, "tpcn_molecules.csv")
    working_dir      = os.path.join(tpcn_dir, "Working")
    half_dir         = os.path.join(tpcn_dir, "Half_working")
    fake_dir         = os.path.join(tpcn_dir, "Fake_working")
    large_dir        = os.path.join(tpcn_dir, "Working_Large")
    non_working_path = os.path.join(tpcn_dir, "non-working.txt")
    summary_path     = os.path.join(tpcn_dir, "summary.txt")
    errors_path      = os.path.join(tpcn_dir, "errors.txt")
